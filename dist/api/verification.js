 ...
 */
export async function insertVerification(msg) {
 ...
 */
export async function upsertVerifications(verifications) {
 ...
 * @param msg Hub event in JSON format
 */
export async function deleteVerification(msg) {
    const fid = msg.data.fid;
 ...
 */
export async function updateVerification(msg, change) {
    const fid = msg.data.fid;
    const address = formatHash(msg.data.verificationAddEthAddressBody.address);
    try {
        await db
