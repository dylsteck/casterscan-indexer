...
import { FormattedHubEvent, MergeMessageHubEvent } from './types/index.js'

const HUB_URL = process.env.HUB_URL

if (!HUB_URL) {
  throw new Error('HUB_URL env variable is not set')
}

let latestEventId: number
export const client = getSSLHubRpcClient(HUB_URL)
